                ...
                view! {
                    <div>
                        ...
                        <div class="admin-view-header">
                            ...
                            <div>
                                <h1 class="admin-view-title">"Admin Panel"</h1>
                                <p class="admin-view-subtitle">
                                    "Manage MidManStudio accounts and review registry submissions."
                                </p>
                            </div>
                        </div>
                        ...
                        {move || {
                            ...
                            view! {
                                <div class="admin-stats-row">
                                    <AdminStatCard label="Total Users" value=total.to_string() />
                                    <AdminStatCard label="Admins"      value=admins.to_string() />
                                    <AdminStatCard label="Users"       value=users.to_string() />
                                </div>
                            }
                        }}
...
#[component]
fn AdminStatCard(label: &'static str, value: String) -> impl IntoView {
    view! {
